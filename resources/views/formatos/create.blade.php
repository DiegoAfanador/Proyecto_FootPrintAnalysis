<!--- La variable $medica se encuentra en el index la cual fue creada por medio de un foreach que recorre la variable creada en el controlador en la parte del index, la cual tiene asignado el modelo como tal! -->
  ...
  <br>
	...
	<div class="row">
		<div class="col-md-3 mb-3">
			<div class="form-group">
				...
				<select class="custom-select" name="sistemadesaludM" required title="Eliga una Opción">
    ...
    <div class="col-md-2 mb-3">
      <div class="form-group">
        <strong>Eps</strong>
        <!-- es necesario que el input en el value por medio de la variable que recibimos en la vista asignemos que necesitamos el valor de la variable sistemadesaludM -->
        <select class="custom-select" name="eps1M" required title="Eliga una Opción">
              <option value="">Seleccione..</option>
    ...
    <div class="col-md-1 mb-3">
      <div class="form-group mt-4">
        <a class="btn btn-primary" href="{{route('entidads.create')}}">+</a>
      </div>
    </div>
	...
	<div class="col-md-2 mb-3">
		<div class="form-group">
			...
			<select class="custom-select" name="arl1M" required title="Elija una Opción">
              <option value="">Seleccione..</option>
...
<!--	<div class="col-md-1 d-flex align-self-center">
		<div class="align-self-center mt-3">
			<a href="aregar.php" type="button" class="btn btn-md boton " title="Agregar EPS/ARL"><i class="fas fa-plus"></i></a>
		</div>
	</div>-->
	...
	<div class="col-md-2 mb-3">
		<div class="form-group">
			<strong>Talla</strong>
			<!-- es necesario que el input en el value por medio de la variable que recibimos en la vista asignemos que necesitamos el valor de la variable tallaM -->
			<select class="custom-select" name="tallaM" required title="Elija una Opción">
              <option value="">Seleccione..</option>
	...
	<!--		<input type="text" name="tallaM"  class="form-control" placeholder="S"> -->
		</div>
	</div>
	<div class="col-md-2 mb-3">
		<div class="form-group">
			...
			<input type="text" name="pesoM"  class="form-control" placeholder="100Kg">
		</div>
	</div>
	...
	<div class="col-md-3 mb-3">
		<div class="form-group">
			...
			<!-- es necesario que el input en el value por medio de la variable que recibimos en la vista asignemos que necesitamos el valor de la variable frecuenciacardiacaM -->
			<input type="text" name="frecuenciacardiacaM"  class="form-control" placeholder="60 Latidos">
		</div>
	</div>
	...
	<div class="col-md-3 mb-3">
		<div class="form-group">
			...
			<input type="text" name="frecuenciarespiratoriaM"  class="form-control" placeholder="44 Respiraciones">
		</div>
	</div>
...
<!-- tabla de enfermedades -->
    ...
    <table class="table">
     ...
     <div class="col-md-12 col-md-offset-5">
      <div class="text-center"><label for='observacionesM'>Observaciones</label>
      </div>
    
    <textarea class="form-control" type="text" id="observacionesM" name="observacionesM" rows="3"></textarea>
  </div>
  <br>
  <br>
