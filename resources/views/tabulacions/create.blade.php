...
<form action="{{ route('tabulacions.store') }}" method="POST">
	...
	<form class="form-group">
			...
			<div class="row shadow p-3 mb-5 rounded">
				<div class="col">
					<table class="table table-borderless table-hover" >
						...
						<tr>
							<td>Tipo de pie (%X)</td>
							<td><input class="form-control w-50" type="text" id="tipoPdTab"  ></td>
		...
		<div class="container">
			<div class="col-12 text-center p-4 shadow mb-5 bg-white rounded">
				...
				<button class="btn btn-md boton" type="submit">Siguiente</button>			
			</div>
		</div>
